"""
Find best balance between volume and profitability for ETH.
"""
import sys
import os
...
print('\n' + '='*60)
print('TOP 10 PROFITABLE HIGH-VOLUME ETH CONFIGURATIONS')
print('='*60)
...
if best:
    ...
    print("\nNo profitable ETH configurations found!")
